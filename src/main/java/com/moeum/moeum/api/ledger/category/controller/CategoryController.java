...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<List<CategoryResponseDto>> getCategoryTreeList(@AuthenticationPrincipal CustomUserDetails userDetails) {
        return ResponseEntity.ok(categoryService.getCategoryTreeList(userDetails.getId()));
    }
